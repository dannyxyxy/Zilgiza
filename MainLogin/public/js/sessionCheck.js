          ...
          userInfo = snapshot.val(); //snapshot.val()에 user 테이블에 있는 해당 개체 정보가 넘어온다. userInfo에 대입!
              ...
              if(document.getElementById("titleCheck").textContent=="mypage"){
                ...
                if (snapshot.val().comment) {
                    ...
                    console.log("소개글이 저장되어 있네요");
                } else {
                    //없으면 더미 데이터 넣어준다.
                    document.getElementById("statetxt").textContent = "자신을 소개하는 글을 적고 프로필 사진을 선택하세요.";
                    console.log("소개글이 없습니다.");
                }
            }else{
            //index.html에서 호출 했다면
            ...
            return true
              ...
              $('#comment').val("로그인을 해서 사람들이 즐긴 축제 리뷰를 보세요!");
        return false
      }
    });
  }
